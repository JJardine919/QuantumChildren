//+------------------------------------------------------------------+
//|                                             BTCUSD_GridTrader.mq5 |
//|                      Bitcoin Grid Trading EA with Entropy Filter  |
...
{
   Print("========================================================");
   Print("BTCUSD GRID TRADER - ENTROPY FILTERED");
   Print("========================================================");
   ...
   if(!g_gridManager.Initialize("BTCUSD", g_magic, g_accountId))
   {
...
void OnDeinit(const int reason)
{
   ...
   Print("BTCUSD Grid Trader stopped. Reason: ", reason);
}
